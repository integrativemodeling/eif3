...
#      # posC2 = str(LinkC2)
       ...
       ScoreIA2 = []
       for i in listX11:
              SA2= getScoreInteractions(listX11, outDiff[i])
              ScoreIA2.append(SA2)
              S10 = sum(ScoreIA2)
       print S10
...
#       ScoreIF2 = []
#       for i in listX16:
 #             SF2= getScoreInteractions(listX16, outDiff[i])
 #             ScoreIF2.append(SF2)
 #             S15 = sum(ScoreIF2)
 #      print S15
 ...
 #      ScoreIG2 = []
 #      for i in listX17:
 #             SG2= getScoreInteractions(listX17, outDiff[i])
 #             ScoreIG2.append(SG2)
 #             S16 = sum(ScoreIG2)
 #      print S16
...
#       list16.append(eS16)
       ...
       SummaryFileName = 'details-eif3A1-upd.csv'
